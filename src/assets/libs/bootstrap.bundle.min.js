...
!(function(e, t) {
	"object" == typeof exports && "undefined" != typeof module
		? t(exports, require("@/assets/libs/jquery.min.js"))
		: "function" == typeof define && define.amd
		? define(["exports", "@/assets/libs/jquery.min.js"], t)
								...
								if (0 < i)
									for (var r = 0; r < i; r++) {
										var o = this._triggerArray[r],
											s = we.getSelectorFromElement(o);
										if (null !== s)
											oe([].slice.call(document.querySelectorAll(s))).hasClass(
												de
											) ||
												oe(o)
													.addClass(ge)
	...
	var Tt,
		...
		(Xt = (function() {
			...
			return (
				...
				(e._getConfig = function(e) {
					return (
						(e = l({}, this.constructor.Default, Tt(this._element).data(), e)),
