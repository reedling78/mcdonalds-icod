<template>
  <div class="p1a-automc-screen screen-type--dt">
    <div id="box-main">
      ...
      <div id="box-menu" class="menu">
        <img class="imgs" src="@/assets/img/lunch-menu.png">
      </div>
      <div id="box-slides" class="slides">
    ...
    var slidesHeader = [
      {
        type: "foto",
        nombre: "bbq",
        url: this.isLocal() + "bbq.jpg",
        tiempo: 15
      },
      {
        type: "foto",
        nombre: "mcfiesta",
        url: this.isLocal() + "mcfiesta.jpg",
        tiempo: 15
      }
    ];
    ...
    var slidesFooter = [
      {
        type: "foto",
        nombre: "Ensaladas",
        url: this.isLocal() + "ensaladas.png",
        tiempo: 15
      },
      {
        type: "foto",
        nombre: "A la Carta",
        url: this.isLocal() + "aLaCarta.png",
        tiempo: 15
      }
    ];
